...
diesel_trucks = {
    "Hino J05E-US": {"cost_initial": 1320000 * 1.16, "km_per_liter": 8, "maintenance_annual": 0, "capacidad_combustible": 200},
...
for year in range(1, 5):
    number_of_charges = annual_kilometers / electric_distance_per_charge
    electricity_cost = number_of_charges * electric_data["battery_capacity_kwh"] * cost_per_kwh
...
<ol style='text-align: left;'>
    ...
    <li><b>Costo Anual de Eléctrico:</b> Se calculó multiplicando el consumo de energía (kWh por carga) por el costo de la electricidad (pesos/kWh) y el número de cargas necesarias anualmente. Luego se sumaron los costos fijos anuales, los costos de mantenimiento y los costos de reemplazo de batería si aplica.</li>
